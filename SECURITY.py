...
if __name__ == '__main__':
	...
	usernameLbl = Label(root4, text="Moksha", font=('Arial Bold',15), bg=background, fg='#85AD4F')
	...
	Label(root4, text="Launch the APP again to get started the conversation with your chatbot", font=('arial',13), bg=background, fg='#A3A5AB', wraplength=350).pack()
